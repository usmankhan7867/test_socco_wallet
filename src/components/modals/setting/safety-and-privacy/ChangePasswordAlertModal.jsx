...
function ChangePasswordAlertModal({ isOpen, setIsOpen }) {
  function closeModal() {
    setIsOpen(false);
  }
  return (
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back p-6 text-left align-middle shadow-xl transition-all">
                ...
                <p className="text-sm text-center my-4">
                  The user password can only be <br /> definied during the
                  restore process <br /> of the wallet.
                </p>
...
export default ChangePasswordAlertModal;
