...
function RecoveryPhraseAlertModal({ isOpen, setIsOpen, setIsPhraseRevealed }) {
  function closeModal() {
    setIsOpen(false);
  }
  return (
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back p-6 text-left align-middle shadow-xl transition-all">
                ...
                <p className="text-sm text-center my-4">
                  Make sure no body is looking at your screen!
                </p>
...
export default RecoveryPhraseAlertModal;
