...
function NotEnoughAmountModal({ isOpen, setIsOpen }) {
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back px-6 py-8 text-left align-middle shadow-xl transition-all">
                ...
                <Dialog.Title
                  as="h3"
                  className="text-lg text-center text-red-500 font-medium leading-6"
                >
                  Oops.. .Failed!
                </Dialog.Title>

                <p className="text-sm text-center my-4">
                  This quantity of coins is not available.
                </p>
...
export default NotEnoughAmountModal;
