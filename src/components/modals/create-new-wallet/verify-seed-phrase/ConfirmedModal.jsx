...
function ConfirmedModal({ isOpen, setIsOpen }) {
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back px-6 py-8 text-left align-middle shadow-xl transition-all">
                ...
                <p className="text-sm text-center my-4">
                  The Seed Phrase was copied. Please be careful and do not share
                  it with anyone. Remember we do not keep a copy of your secret
                  seed phrase.
                </p>
                ...
                <div className="mt-4">
                  <button
                    ...
                    onClick={() => {
                      closeModal();
                      navigate("/setup-wallet/set-password");
                    }}
                  >
                    Next
                  </button>
