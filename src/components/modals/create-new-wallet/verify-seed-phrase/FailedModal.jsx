...
function FailedModal({ isOpen, setIsOpen }) {
  function closeModal() {
    setIsOpen(false);
  }
  return (
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back px-6 py-8 text-left align-middle shadow-xl transition-all">
                <div className="flex justify-center items-center mb-4 bg-red-400 w-20 h-20 mx-auto rounded-full">
                  <AiFillWarning className="text-4xl" />
                </div>
                <Dialog.Title
                  as="h3"
                  className="text-lg text-center text-red-300 font-medium leading-6"
                >
                  Oops.. .Failed!
                </Dialog.Title>

                <p className="text-sm text-center my-4">
                  Please check the added seed phrases again, if all 4 of the
                  phrases have been placed correctly.
                </p>
