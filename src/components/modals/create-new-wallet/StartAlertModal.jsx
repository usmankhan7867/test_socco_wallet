...
function StartAlertModal({ isOpen, setIsOpen }) {
  function closeModal() {
    setIsOpen(false);
  }
  return (
            ...
            >
              <Dialog.Panel className="w-full max-w-[300px] transform overflow-hidden rounded-2xl bg-back px-6 py-8 text-left align-middle shadow-xl transition-all">
                ...
                <p className="text-sm text-center my-4">
                  If you lose my secret seed phrase, your funds will be lost
                  forever. <br className="py-2" /> Soccercoin will never reach
                  out to you to ask for your seed phrase.
                  <br className="my-5" /> If you share your secret seed phrase,
